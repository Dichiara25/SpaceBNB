...
class FrontofficeOwnerController extends AbstractController
{
    ...
    /**
     * @Route("/frontoffice/owner/new", name="room_new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/frontoffice/owner/{id}", name="room_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/frontoffice/owner/{id}", name="room_delete", methods={"POST"})
     */
